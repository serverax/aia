...
class RAGSystem:
    ...
    def search_qdrant(self, vector: List[float], collection_name="uk_compliance", limit=10) -> List[Dict[str, Any]]:
    ...
    async def query(self, user_query: str, collection_name="uk_compliance") -> Dict[str, Any]:
        ...
        return {
            ...
            "confidence_score": max([doc['score'] for doc in reranked_docs]) if reranked_docs else 0.0
        }
