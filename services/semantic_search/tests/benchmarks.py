...
async def run_benchmarks():
    ...
    recommendation_context = search_engine.search(risk_query, top_k=2, filters={"jurisdiction": "EU"})
    
    integration_success = len(recommendation_context) > 0 and recommendation_context[0]["id"] == "POL_001"
